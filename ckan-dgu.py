...
('Installing dgu code', '%s/bin/pip -E %s install -e hg+https://bitbucket.org/okfn/ckanext-dgu#egg=ckanext-dgu' % (pyenv, pyenv)),
('Installing dgu dependencies', '%s/bin/pip -E %s install -r %s/src/ckanext-dgu/pip-requirements.txt' % (pyenv, pyenv, pyenv)),
