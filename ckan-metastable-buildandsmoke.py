...
cmd = "%s/fab config_local:%s,%s,db_host=localhost,db_pass=biomaik15,no_sudo=True,skip_setup_db=True,pip_requirements=pip-requirements-metastable.txt deploy" % (ve_bin_dir, build_dir, deploy_name)
system(cmd)
